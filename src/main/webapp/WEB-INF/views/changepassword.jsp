...
<form action="update-password" method="post">
	...
	<div class=" container text-center border border-secondary rounded p-3" style="max-width: 350px; margin-top: 40px;" >
		...
		<p>
		<input type="password" name="passField1" class="form-control" placeholder="Enter new password" required="required">
		</p>
		<p>
		<input type="password" name="passField2"  class="form-control" placeholder="confirm new password" required="required" ">
		</p>
